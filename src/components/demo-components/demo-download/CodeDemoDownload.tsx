...
const CodeDemoDownload1 = () => {
  return (
    <ShowDemoCode
      ...
      codeSandboxJS="https://codesandbox.io/s/files-ui-download-diff-origin-1-hcngqo?file=/src/App.js"
      codeSandboxTS="https://codesandbox.io/s/files-ui-download-diff-origin-1-hcngqo?file=/src/App.js"

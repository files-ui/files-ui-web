...
const CodeDemoDownload1 = () => {
  return (
    <ShowDemoCode
      ...
      codeSandboxJS="https://codesandbox.io/s/files-ui-download-diff-origin-2-4y0ivk?file=/src/App.js"
      codeSandboxTS="https://codesandbox.io/s/files-ui-download-diff-origin-2-4y0ivk?file=/src/App.js"

...
export { createListOfMultiTypeFile, uploadFile, uploadFormData, uploadExtFile, ExtFileInstance, ExtFileManager, createUploadConfig } from "theamazingunkowntext";
export type { ExtFile, ExtFileListMap, UPLOADSTATUS, Localization, ServerResponse, UploadResponse, UploadConfig, ValidateFileResponse, IconsMap } from "theamazingunkowntext";

                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            finalExtraData = __assign({ otherValue: "other valueee haaaa", param2: { tecnica: "KIKOHUUUU", friend: "Chaos", age: 25 } }, extFile.extraUploadData);
...
export { Avatar, Dropzone, ExtFileInstance, ExtFileManager, FileCard, FileInputButton, FileMosaic, FilesUiProvider, FullScreen, ImagePreview, MaterialButton, VideoPreview, createListOfMultiTypeFile, createUploadConfig, uploadExtFile, uploadFile, uploadFormData, useFakeProgress };

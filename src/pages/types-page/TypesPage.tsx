        ...
        <MainContentContainer>
          ...
          <section id="validatefileresponse">
            <PropsTableApi
              ...
              title={"ValidateFileResponse" as any}
              omitDefault
              desc={"Response convention for file validation" as any}
            />
          </section>
          <section id="uploadconfig">
            <PropsTableApi
              rows={UploadConfigAPIRows}
              title={"UploadConfig" as any}
              desc={"Configuration needed for performing the upload process" as any}
            />
          </section>
          <section id="actionbuttons">
            <PropsTableApi
              rows={ActionButtonsAPIRows}
              title={"ActionButtons" as any}
              omitDefault
              desc={"Advanced configuration for buttons after or before the component. (Dropzone and FileInputButton)" as any}
            />
          </section>
          <section id="actionbuttonitem">
            <PropsTableApi
              rows={ActionButtonItemAPIRows}
              title={"ActionButtonItem" as any}
              desc={"Advanced configuration for each action button" as any}
            />
          </section>
          <section id="headerconfig">
            <PropsTableApi
              rows={HeaderConfigAPIRows}
              title={"HeaderConfig" as any}
              desc={"Advanced configuration for dropzone header" as any}
            />
          </section>
          <section id="footerconfig">
            <PropsTableApi
              rows={FooterConfigAPIRows}
              title={"FooterConfig" as any}
              desc={"Advanced configuration for dropzone footer" as any}
            />
          </section>
          <section id="serverresponse">
            <PropsTableApi
              rows={ServerResponseAPIRows}
              title={"ServerResponse" as any}
              omitDefault
              desc={"Convention for server response" as any}
            />
          </section>

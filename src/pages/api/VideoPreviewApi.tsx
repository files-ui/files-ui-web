      ...
      <MainContentContainer>
        ...
        <section id="demo">
          ...
          <Alert severity="info">
            ...
            <ul>
              <li>
                <AnchorToTab href="/components/videopreview">
                  VideoPreview
                </AnchorToTab>
              </li>
              <li>
        ...
        <FooterPage
          page="VideoPreview API"
          labelBefore="ImagePreview API"
          linkBefore="/api/imagepreview"
          labelAfter="File Icons"
          linkAfter="/file-icons"
        />
      </MainContentContainer>
      <RightMenuContainer>
        <RightMenu

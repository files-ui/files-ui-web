...
import DemoDropzoneAccessibility from "../../components/demo-components/dropzone-demo/DemoDropzoneAccessibility";
import CodeDemoDropzoneAccessibility from "../../components/demo-components/dropzone-demo/CodeDemoDropzoneAccessibility";
import DemoDropzoneLazyLoad from "../../components/demo-components/dropzone-demo/DemoDropzoneLazyLoad";
  ...
  return (
    <React.Fragment>
      <MainContentContainer>
        ...
        <section id="chunked-upload">
          <SubTitle content="Chunked upload and concurrency" />
          <DescParagraph>
            You can combine <TypeHighlight>uploadConfig.chunked</TypeHighlight>,{" "}
            <TypeHighlight>uploadConfig.chunkSize</TypeHighlight> and{" "}
            <TypeHighlight>maxConcurrentUploads</TypeHighlight> for better upload
            control.
          </DescParagraph>

          <Paper variant="outlined" style={{ padding: "25px" }}>
            <DemoDropzoneChunkedUpload />
          </Paper>
        ...
        <section id="accessibility">
          <SubTitle content="Accessibility" />
          <DescParagraph>
            Keep the dropzone discoverable by using an explicit label and keeping
            header and footer metadata enabled when appropriate.
          </DescParagraph>

          <Paper variant="outlined" style={{ padding: "25px" }}>
            <DemoDropzoneAccessibility />
          </Paper>

          <CodeDemoDropzoneAccessibility />
        </section>

        <section id="lazy-loading">
          <SubTitle content="Lazy loading" />
          <DescParagraph>
            For long file lists, enable <TypeHighlight>lazyLoad</TypeHighlight> so
            only visible items are rendered and scrolling remains responsive.
          </DescParagraph>

          <Paper variant="outlined" style={{ padding: "25px" }}>
            <DemoDropzoneLazyLoad />
          </Paper>

          <CodeDemoDropzoneLazyLoad />
        </section>
...
const rightMenuItems = [
  ...
  },
  {
    id: 17,
    label: "Accessibility",
    referTo: "/components/dropzone#accessibility",
  },
  {
    id: 18,
    label: "Lazy loading",
    referTo: "/components/dropzone#lazy-loading",
  },
  {
    id: 7,
    label: "Localization",

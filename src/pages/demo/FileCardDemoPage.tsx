    ...
    <React.Fragment>
      <MainContentContainer>
        ...
        <Alert severity="info">
          ...
          of the behavior demonstrated here is not totally shown in
          context.{" "}
        </Alert>
        ...
        <section id="selection">
          ...
          <DescParagraph>
            Enable selection using <CodeHighlight>selectable</CodeHighlight> and
            control checked state with <CodeHighlight>selected</CodeHighlight>.
            The <CodeHighlight>onSelect</CodeHighlight> callback receives the
            file id and the next checked value.
          </DescParagraph>

          <DemoFileMosaicSelection card />
        ...
        <FooterPage
          page="FileCard Demo"
          labelBefore="FileInputDemo Demo"
          linkBefore="/components/fileinputbutton"
          labelAfter="FullScreen Demo"
          linkAfter="/components/fullscreen"
        />
      </MainContentContainer>
      <RightMenuContainer>
        <RightMenu

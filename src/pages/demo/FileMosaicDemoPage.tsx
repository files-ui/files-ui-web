...
import DemoFileMosaicVideoDownload from "../../components/demo-components/filemosaic-demo/DemoFileMosaicVideoDownload";
    ...
    <React.Fragment>
      <MainContentContainer>
        ...
        <section id="video-download">
          ...
          <DescParagraph>
            If both <CodeHighlight>videoUrl</CodeHighlight> and{" "}
            <CodeHighlight>downloadUrl</CodeHighlight> are provided for a video,
            the component prioritizes <CodeHighlight>videoUrl</CodeHighlight>.
          </DescParagraph>

          <DemoContainerFileMosaic>
            <DemoFileMosaicVideoDownload />
          </DemoContainerFileMosaic>

          <CodeJSFileMosaicVideoDownload />
        </section>

        <section id="selection">
          <SubTitle content="Selection" />
          <DescParagraph>
            Enable <CodeHighlight>selectable</CodeHighlight> to render a selection
            control and use <CodeHighlight>selected</CodeHighlight> with{" "}
            <CodeHighlight>onSelect</CodeHighlight> for controlled selection state.
          </DescParagraph>

          <DemoFileMosaicSelection />

          <CodeJSFileMosaicSelection />
        </section>
        <section id="dark-mode">
          ...
          <CodeJSFileMosaicDarkMode card={false} />
        </section>
...
const rightMenuItems = [
  ...
  },
  {
    ...
    referTo: "/components/filemosaic#video-download",
  },
  {
    id: 9,
    label: "Selection",
    referTo: "/components/filemosaic#selection",
  },
  {
    id: 5,
    label: "Dark mode",
